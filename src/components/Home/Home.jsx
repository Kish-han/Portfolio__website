            ...
            <div className="wrapper bg-secondarycolor w-full h-full md:flex">
                <div className="leftwrap w-full h-full flex justify-center items-center md:w-[50%] md:h-full">
                    <div className="text-5xl md:text-7xl text-white z-50">
                        ...
                        <button className="text-xl font-semibold border border-primarycolor text-primarycolor rounded-tl-lg rounded-br-lg px-4 py-2 mt-7  transition transform duration-200 hover:scale-105 active:scale-95 hover:shadow-md hover:shadow-primarycolor ">
                            Contact me
                        </button>
                    </div>
                </div>
